...
public class LotteryControllerTest {
    ...
    private org.mockito.MockedStatic<com.google.firebase.firestore.FirebaseFirestore> mockedFirestore;
    ...
    @Before
    public void setUp() {
        // Intercept Firebase initialization
        mockedFirestore = Mockito.mockStatic(com.google.firebase.firestore.FirebaseFirestore.class);
        mockedFirestore.when(com.google.firebase.firestore.FirebaseFirestore::getInstance)
                .thenReturn(Mockito.mock(com.google.firebase.firestore.FirebaseFirestore.class, Mockito.RETURNS_DEEP_STUBS));
    ...
    public void testRunLottery_SucceedsInstantlyIfNoEligibleEntrants() {
        ...
        doAnswer(invocation -> {
            RepositoryCallback<Void> cb = invocation.getArgument(1);
            cb.onSuccess(null);
            return null;
        }).when(mockEventRepo).updateEvent(any(Event.class), any());
    ...
    public void tearDown() {
        ...
        if (mockedSystemLog != null) mockedSystemLog.close();
    }
